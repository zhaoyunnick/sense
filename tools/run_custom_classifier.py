...
def run_custom_classifier(custom_classifier, camera_id=0, path_in=None, path_out=None, title=None, use_gpu=True,
    ...
    display_ops = [
        display.DisplayFPS(expected_camera_fps=net.fps,
                            expected_inference_fps=net.fps / net.step_size),
        display.DisplayTopKClassificationOutputs(top_k=1, threshold=0.1),
    ]
    display_results = display.DisplayResults(title=title, display_ops=display_ops, display_fn=display_fn)
